...
def run_TrueWalks(ontology_file_path, annotations_file_path, vector_size, n_walks, walk_depth, language_model, path_output, path_entity_file):
    """
...
if __name__== '__main__':
    ...
    path_output = "Embeddings/PPI/"
    path_entity_file = "Data/PPI/Prots.txt"
    ontology_file_path = "Data/GO/go.owl"
    annotations_file_path = "Data/GO/GO_annotations.tsv"
    run_TrueWalks(ontology_file_path, annotations_file_path, vector_size, n_walks, walk_depth, language_model,
                         path_output, path_entity_file)
