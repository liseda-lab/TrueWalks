...
from configuration import FILE_DATASET,OPERATION,EMBEDDING_FILES,PATH_OUTPUT_ML,PATH_PARTITION_ML,N_PARTITIONS,TEST_SIZE
...
def run_cross_validation(list_embeddings_files, file_dataset_path, operation, path_results, path_partition, n_partition=30, test_size=0.3, make_partitions=True):
    """
...
if __name__ == "__main__":
    ...
    path_results = PATH_OUTPUT_ML
    path_partition = PATH_PARTITION_ML
