...
class KG(object):
    ...
    def _get_rhops(self, vertex: str, forbidden_links: List[str]) -> List[Tuple[str, str]]:
        ...
        for pred in predicates:
            if str(pred) not in forbidden_links:
    ...
    def get_hops(self, vertex: str, forbidden_links: List[str]) -> List[Tuple[str, str]]:
        return self._get_rhops(vertex, forbidden_links)
